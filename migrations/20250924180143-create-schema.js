...
export async function down({ context }) {
  ...
  await queryInterface.removeConstraint('user_followers', 'fk_user_followers_following').catch(() => {});
  await queryInterface.removeConstraint('user_followers', 'fk_user_followers_follower').catch(() => {});
  await queryInterface.removeConstraint('testimonials', 'fk_testimonials_owner').catch(() => {});
  await queryInterface.removeConstraint('recipe_ingredients', 'fk_recipe_ingredients_ingredient').catch(() => {});
  await queryInterface.removeConstraint('recipe_ingredients', 'fk_recipe_ingredients_recipe').catch(() => {});
  await queryInterface.removeConstraint('recipes', 'fk_recipes_category').catch(() => {});
  await queryInterface.removeConstraint('recipes', 'fk_recipes_area').catch(() => {});
  await queryInterface.removeConstraint('recipes', 'fk_recipes_owner').catch(() => {});
  await queryInterface.removeConstraint('user_followers', 'pk_user_followers').catch(() => {});
  await queryInterface.removeConstraint('recipe_ingredients', 'uniq_recipe_ingredient').catch(() => {});
